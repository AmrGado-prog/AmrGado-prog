...
![Angular](https://img.shields.io/badge/Angular-DD0031?style=flat&logo=angular&logoColor=whit)
...
![RESTful APIs](https://img.shields.io/badge/RESTful_APIs-02569B?style=flat&logo=api&logoColor=white)
...
class About extends Me { 
  const myTools = {  
    "ProgramingLanguages" : { "HTML5", "CSS3", "JavaScript (ES6+)", "TypeScript", "Dart" },
    "Editors" : { "Vscode" },
